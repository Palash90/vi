...
Some Shortcuts
=================
It is actually boring and frustrating to edit a lot of text.
While manipulating text, you may have felt that, it would be
nice to have some shortcuts to ease editing tasks.
Actually there are some. This whole chapter will discover 
them one by one.
A word of caution, if you are not habituated with all the 
movement and change operators, and the ex commands that we
...
and discard all the changes. Unfortunately you have to redo 
all the required changes. Horrible idea...
...
undone. Let's try this in a practical way.
We will start with a fresh copy of the limerick, we were
...
to do that once you are in third line by using j/k
movements. The text in the editor looks like the following -
```
...
In other cases, you may be in between a line and you want to
